...
//        users = new ArrayList<>();
//
//        Media movie1 = new Movie("Venom", "2018,Oct,05", 1);
//        Media movie2 = new Movie("CreedII", "2018,Nov,21", 1);
//        Media movie3 = new Movie("Spider-Man:IntoTheSpider-Verse", "2018,Dec,14", 1);
//
